...
<%
	...
	dim tagName
	tagName = trim(request.querystring("tag"))
...
<div id="SearchResult" >
	...
	<ul>
		<%
			...
			sql = "select * from CMS_Article where CMS_Title like '%"&tagName&"%' or CMS_Keyword like '%"&tagName&"%' or CMS_Content like '%"&tagName&"%' or CMS_Tag like '%"&tagName&"%'"
