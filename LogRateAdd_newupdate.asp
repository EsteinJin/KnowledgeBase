...
addsql="Insert into CMS_LogRate(CMS_Date,CMS_TicketNumber,CMS_AgentName,CMS_Language,CMS_Remote,CMS_Compliance,CMS_HandleTime,CMS_Summary,CMS_CallType) values (now(),'"&CMS_TicketNumber&"','"&CMS_AgentName&"','"&CMS_Language&"','"&CMS_Remote&"','"&CMS_Compliance&"','"&CMS_HandleTime&"','"&CMS_Summary&"','"&CMS_CallType&"')"
	conn.execute(addsql)
...
<dd>
Summary：
<input type="text" name="CMS_Summary"  style=" width:300px;"   /> 
</dd>
