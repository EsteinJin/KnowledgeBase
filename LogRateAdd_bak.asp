...
xmlhttp.open("GET","/gethintTest.asp?q="+str,true);
xmlhttp.send();
...
<a href="LogRate.html" style="font-family:Arial; float:right">Daily Issue Stastistics</a></dt><br/><br/>
...
<form action=""> 
KB Search(Lets have try!)<input type="text" id="txt1" style=" width:200px;" onKeyUp="showHint(this.value)" />
...
<a  href="im:<sip:RGCNSISGOEUSBASF@internal.siemens-it-solutions.com>">water</a>
