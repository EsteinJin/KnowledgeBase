    ...
    <td valign="top"><table border="0" width="100%" height="100%" cellspacing="5" cellpadding="0">
        <tr>
          <td valign="top"><img src="image/header-grey.jpg" border="0" width="600" height="100" vspace="0" hspace="0" alt=""><br>
                ...
                <TABLE class=search2 border=0 cellSpacing=1 cellPadding=2 
                  ...
                  <TBODY>
                    <TR>
                      ...
                      <TD class=result-header>Title----<span style="color:red">Cascade Related Article List</span></TD>
            ...
            sql = "select  * from CMS_Article where  CMS_Rmp=1 order by CMS_Date desc"
                ...
                <TABLE border=0 cellSpacing=0 cellPadding=0 width=500>
                  <TBODY>
                    <TR>
					  ...
					  %>
                      <TD align=middle><a href="CascadeList.asp?page=1">[Main]</a> <a href="CascadeList.asp?page=<%=(page-1)%>">[Previous]</a></TD>
                      <%
					  end if 
					  ...
					  %>
                      <TD align=middle><a href="CascadeList.asp?page=<%=page+1%>">[Next]</a> <a href="CascadeList.asp?page=<%=rs.pagecount%>">[End]</a></TD>                      
